                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                   ...
                   <!-- <li class="has-child"><a href="#">CAUSES</a>
                    ...
                    <li><a href="thanku.jsp">GRATITUDE</a></li>
        ...
        <div>Donate Now</div>
                ...
                <form method="post" action="http://localhost:16858/happyness/Donationform.jsp">
                    <table align="center" >
                        ...
                        <tr><td><h4>Description:<td><textarea name="descr" rows="5" cols="20"required>
                                        </textarea>
                                    </td></td></tr>
        ...
        i=rs.getInt(1)+1;
           ...
           String desc=request.getParameter("desc");
               ...
               PreparedStatement stmt=con.prepareStatement("insert into donarlist values(?,?,?,?,?,?,?)");
                        ...
                        if(rs1>0)
                        {
                           // response.sendRedirect("http://localhost:16858/happyness/thanku.jsp");
                        }
